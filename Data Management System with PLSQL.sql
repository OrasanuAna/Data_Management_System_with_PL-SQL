-- Ștergerea tabelelor
DROP TABLE Sarcini_AMO CASCADE CONSTRAINTS PURGE;
DROP TABLE Vehicule_AMO CASCADE CONSTRAINTS PURGE;
DROP TABLE Contracte_AMO CASCADE CONSTRAINTS PURGE;
DROP TABLE Documente_AMO CASCADE CONSTRAINTS PURGE;
DROP TABLE Soferi_AMO CASCADE CONSTRAINTS PURGE;
DROP TABLE Utilizatori_AMO CASCADE CONSTRAINTS PURGE;

------------------------------------------------------------------------------------------------------------------------------------------------------------------------
-- Crearea tabelelor
-- 1. Crearea tabelei Utilizatori_AMO
...
CREATE TABLE Sarcini_AMO(
   ...
   CONSTRAINT fk_UtilizatorID_Sarcini_AMO FOREIGN KEY(UtilizatorID) REFERENCES Utilizatori_AMO(UtilizatorID) ON DELETE CASCADE
);

-- 3. Crearea tabelei Soferi_AMO
CREATE TABLE Soferi_AMO(
   ...
   CONSTRAINT fk_UtilizatorID_Soferi_AMO FOREIGN KEY(UtilizatorID) REFERENCES Utilizatori_AMO(UtilizatorID) ON DELETE CASCADE
);

-- 4. Crearea tabelei Vehicule_AMO
CREATE TABLE Vehicule_AMO(
   ...
   CONSTRAINT fk_SoferID FOREIGN KEY(SoferID) REFERENCES Soferi_AMO(SoferID) ON DELETE SET NULL,
   CONSTRAINT fk_UtilizatorID_Vehicule_AMO FOREIGN KEY(UtilizatorID) REFERENCES Utilizatori_AMO(UtilizatorID) ON DELETE CASCADE
);

-- 5. Crearea tabelei Contracte_AMO
CREATE TABLE Contracte_AMO(
   ...
   CONSTRAINT fk_UtilizatorID_Contracte_AMO FOREIGN KEY(UtilizatorID) REFERENCES Utilizatori_AMO(UtilizatorID) ON DELETE CASCADE
);

-- 6. Crearea tabelei Documente_AMO
CREATE TABLE Documente_AMO(
   ...
   CONSTRAINT fk_UtilizatorID_Documente_AMO FOREIGN KEY(UtilizatorID) REFERENCES Utilizatori_AMO(UtilizatorID) ON DELETE CASCADE
);
...
-- 4. Inserarea de valori în tabelul Contracte_AMO
INSERT INTO Contracte_AMO 
    (ContractID, NumeContract, TipContract, DataInceputContract, DataSfarsitContract, UtilizatorID)
VALUES
    (1, 'Contract de munca', 'Munca', TO_DATE('2022-01-10', 'YYYY-MM-DD'), TO_DATE('2023-01-10', 'YYYY-MM-DD'), 1),
    (2, 'Contract de inchiriere', 'Inchiriere', TO_DATE('2022-02-15', 'YYYY-MM-DD'), TO_DATE('2023-02-15', 'YYYY-MM-DD'), 2),
    (3, 'Contract de asigurare', 'Asigurare', TO_DATE('2022-03-20', 'YYYY-MM-DD'), TO_DATE('2023-03-20', 'YYYY-MM-DD'), 2),
    (4, 'Contract de consultanta', 'Consultanta', TO_DATE('2022-04-25', 'YYYY-MM-DD'), TO_DATE('2023-04-25', 'YYYY-MM-DD'), 3),
    (5, 'Contract de vanzare-cumparare', 'Vanzare-Cumparare', TO_DATE('2022-05-30', 'YYYY-MM-DD'), TO_DATE('2023-05-30', 'YYYY-MM-DD'), 4);

-- Verificarea inserărilor
...
-- 6. Inserarea de valori în tabelul Sarcini_AMO
INSERT INTO Sarcini_AMO 
    (SarcinaID, NumeSarcina, DescriereSarcina, TermenLimitaSarcina, UtilizatorID)
VALUES
    (1, 'Implementare functionalitate', 'Implementarea unei noi functionalitati in aplicatie', TO_DATE('2022-01-20', 'YYYY-MM-DD'), 1),
    (2, 'Testare software', 'Testarea si depanarea erorilor in aplicatie', TO_DATE('2022-02-25', 'YYYY-MM-DD'), 1),
    (3, 'Raport lunar', 'Generarea rapoartelor de activitate lunara', TO_DATE('2022-03-15', 'YYYY-MM-DD'), 2),
    (4, 'Intalnire cu clientii', 'Organizarea unei intalniri pentru discutarea cerintelor clientilor', TO_DATE('2022-04-05', 'YYYY-MM-DD'), 3),
    (5, 'Optimizare baza de date', 'Optimizarea performantei bazei de date', TO_DATE('2022-05-10', 'YYYY-MM-DD'), 3);
